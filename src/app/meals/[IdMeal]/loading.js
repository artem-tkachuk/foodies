        ...
        <>
            <header className={styles.header}>
                ...
                <div className={styles.headerText}>
                    ...
                    <p className={`${styles.creator} loading`}>Loading creator...</p>
                    <p className={`${styles.summary} loading`}>Loading summary...</p>
                </div>
            </header>
            <main className={styles.main}>
                <p className={`${styles.instructions} loading`}>Loading instructions...</p>
            </main>
        </>
    );
} 